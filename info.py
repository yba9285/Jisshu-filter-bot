...
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Me.Yogiraaj"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "AoneMarathi")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002124208809").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002937430915 -1003043479551 -1002954400920"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002606471643"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002606471643"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002606471643"))
...
request_channel = environ.get("REQUEST_CHANNEL", "-1002606471643")
REQUEST_CHANNEL = (
    int(request_channel)
